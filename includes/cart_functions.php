...
function update_cart_quantity(int $cartId, int $customerId, int $quantity): void
{
    ...
    $stmt = db()->prepare(
        'UPDATE cart c
         ...
         SET c.quantity = LEAST(:quantity, i.quantity)
